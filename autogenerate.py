# This code is from this github issues thread.
...
MODEL_FP = "/scratch/work/jpleino1/chatbot/FinetuningTransformerXL/LM-TFM-Ctrain/20191017-145138/model.pt"
USE_CUDA = True
BATCH_SIZE = 1
TGT_LEN = 1
EXT_LEN = 0
...
print(samples.shape)
torch.save(samples, "generated_chatbot.pt")
